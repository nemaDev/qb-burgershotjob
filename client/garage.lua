    ...
    while true do
        ...
        for k, v in pairs(Config.GaragePedLocations) do
            ...
            if dist < 40 and not pedspawned then
                TriggerEvent('qb-burgershotjob:spawn:ped', v.coords)
                pedspawned = true
            end
            if dist >= 35 then
                pedspawned = false
...
RegisterNetEvent('qb-burgershotjob:spawn:ped')
AddEventHandler('qb-burgershotjob:spawn:ped',function(coords)
    local hash = `ig_floyd`
...
RegisterNetEvent('qb-burgershotjob:garage')
AddEventHandler('qb-burgershotjob:garage', function(bs)
...
RegisterNetEvent('qb-burgershotjob:storecar')
AddEventHandler('qb-burgershotjob:storecar', function()
