...
RegisterServerEvent("qb-burgershotjob:bill:player")
AddEventHandler("qb-burgershotjob:bill:player", function(playerId, amount)
...
QBCore.Functions.CreateCallback('qb-burgershotjob:server:get:ingredientBurger', function(source, cb)
    local src = source
...
QBCore.Functions.CreateCallback('qb-burgershotjob:server:get:ingredientTorpedo', function(source, cb)
    local src = source
    local Ply = QBCore.Functions.GetPlayer(src)
    local meat = Ply.Functions.GetItemByName("burger-meat")
    local bun = Ply.Functions.GetItemByName("burger-bun")
...
QBCore.Functions.CreateCallback('qb-burgershotjob:server:get:ingredientMeatfree', function(source, cb)
    local src = source
    local Ply = QBCore.Functions.GetPlayer(src)
    local bun = Ply.Functions.GetItemByName("burger-bun")
    local tomato = Ply.Functions.GetItemByName("burger-tomato")
...
QBCore.Functions.CreateCallback('qb-burgershotjob:server:get:ingredientMurderMeal', function(source, cb)
    local src = source
    local Ply = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateUseableItem("burger-murdermeal", function(source, item)
    ...
    TriggerClientEvent("qb-burgershotjob:MurderMeal", source, item.name)
end)
